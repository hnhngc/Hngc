...
namespace Game02
{
    public partial class lvl_c : Form
    {
        ...
        private bool hasItemFromForm2 = false;
        ...
        private void KeyIsUp(object sender, KeyEventArgs e)
        {
            ...
            if (picCave.Bounds.IntersectsWith(picPlayer.Bounds) && hasItemFromForm2)
            {
                Cave cave = new Cave(score, SelectChar);
                this.Hide();
                GameTimer.Stop();
                cave.ShowDialog();
                this.Close();
            ...
            {
                lvl_e newLevel = new lvl_e(scoreFromPreviousLevel, SelectChar);
                this.Hide();
                GameTimer.Stop();
                newLevel.Show();
                this.Close();
        ...
        public void SetHasItemFromForm2(bool value)
        {
            hasItemFromForm2 = value;
        }
